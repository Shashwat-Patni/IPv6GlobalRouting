...
class GlobalRoutingLSA
{
  ...
  public:
     ...
     */
    uint32_t AddLinkRecord(GlobalRoutingLinkRecord<T, Enable>* lr);
     ...
     * @returns The number of link records in the list.
     */
    GlobalRoutingLinkRecord<T, Enable>* GetLinkRecord(uint32_t n) const;
  ...
  private:
     ...
     */
    typedef std::list<GlobalRoutingLinkRecord<T, Enable>*> ListOfLinkRecords_t;
 ...
 */
template <typename T, typename Enable>
std::ostream& operator<<(std::ostream& os, GlobalRoutingLSA<T, Enable>& lsa);
...
class GlobalRouter : public Object
{
  ...
  public:
     ...
     */
    bool GetLSA(uint32_t n, GlobalRoutingLSA<T, Enable>& lsa) const;
  ...
  private:
     ...
     */
    void ProcessBroadcastLink(Ptr<NetDevice> nd,
     ...
     * @param pLSA the Global LSA
     */
    void ProcessPointToPointLink(Ptr<NetDevice> ndLocal, GlobalRoutingLSA<T, Enable>* pLSA);
    ...
    typedef std::list<GlobalRoutingLSA<T, Enable>*>
