...
LinkTest::DoRun()
{
    ...
    Ptr<GlobalRouting<Ipv4RoutingProtocol>> globalRouting1 =
        routing1->GetObject<GlobalRouting<Ipv4RoutingProtocol>>();
...
BridgeTest::DoRun()
{
    ...
    Ptr<GlobalRouting<Ipv4RoutingProtocol>> globalRouting4 =
        routing4->GetObject<GlobalRouting<Ipv4RoutingProtocol>>();
                                         ...
                                         std::vector<Ipv4Address> path)
{
    ...
    Ptr<GlobalRouting<Ipv4RoutingProtocol>> globalRouting =
        routing->GetObject<GlobalRouting<Ipv4RoutingProtocol>>();
    ...
    for (uint32_t i = 1; i < pathSize; i++)
    {
        ...
        globalRouting = routing->GetObject<GlobalRouting<Ipv4RoutingProtocol>>();
        NS_TEST_ASSERT_MSG_NE(globalRouting,
                              nullptr,
